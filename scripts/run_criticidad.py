"""
Criticidad — CLI sobre cf_pf_core.

El calculo vive en cf_pf_core (paso 'criticidad'); este archivo solo lo invoca desde
...
Las opciones disponibles se derivan del core. Para verlas:
    python scripts\run_criticidad.py --help
"""
import os
import sys
