"""
PF Probabilidad de Falla — CLI sobre cf_pf_core.

El calculo vive en cf_pf_core (paso 'pf'); este archivo solo lo invoca desde
...
Las opciones disponibles se derivan del core. Para verlas:
    python scripts\run_pf_probabilidad_falla.py --help
"""
import os
import sys
