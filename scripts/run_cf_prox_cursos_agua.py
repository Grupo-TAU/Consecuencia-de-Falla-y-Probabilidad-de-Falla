"""
CF Proximidad a Cursos de Agua — CLI sobre cf_pf_core.

El calculo vive en cf_pf_core (paso 'prox_medioamb'); este archivo solo lo invoca desde
...
Las opciones disponibles se derivan del core. Para verlas:
    python scripts\run_cf_prox_cursos_agua.py --help
"""
import os
import sys
