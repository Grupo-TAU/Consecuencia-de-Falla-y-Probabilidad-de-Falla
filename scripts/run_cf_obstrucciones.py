"""
CF Obstrucciones — CLI sobre cf_pf_core.

El calculo vive en cf_pf_core (paso 'obstrucciones'); este archivo solo lo invoca desde
...
Las opciones disponibles se derivan del core. Para verlas:
    python scripts\run_cf_obstrucciones.py --help
"""
import os
import sys
