"""
CF Proximidad a Sitios de Interes — CLI sobre cf_pf_core.

El calculo vive en cf_pf_core (paso 'prox_sitios'); este archivo solo lo invoca desde
...
Las opciones disponibles se derivan del core. Para verlas:
    python scripts\run_cf_prox_sitios_interes.py --help
"""
import os
import sys
